 ...
 * */
/**
 * UserVis object for HW3 of CS171
...
UserVis.prototype.initVis = function() {
  ...
  console.log("example")
    ...
    var secondsvg = d3.select(".usersvg").append("text")
        .text("User Percentages")
        .attr("class", "text")
...
UserVis.prototype.onSelectionChange = function(selectionStart, selectionEnd) {
...
UserVis.prototype.filterAndAggregate = function(_filter) {
